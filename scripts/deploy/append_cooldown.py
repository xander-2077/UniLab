...
def main() -> None:
    ...
    if K > 0:
        parts_jp.append(jp_h);   parts_jv.append(jv_h)
        parts_bp.append(bp_h);   parts_bq.append(bq_h)
        parts_bv.append(bv_h);   parts_bav.append(bav_h)
    ...
    print(f"  seam check (orig last frame vs cooldown first frame; one-dt-step apart):")
